...
export const presets = [
  ...
  {id: 'create-ai-assignment', label: 'Create assignment (AI enabled)', group: 'Documents and assignments', help: 'Requires server EXTERNAL_AI_ENABLED and credentials for AI calls. Set ocr_enabled to true for Mathpix if configured.', build: c => post(`${cpath(c)}/assignments`, assignmentBody(c, true))},
