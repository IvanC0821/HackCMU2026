...
export const gradedExampleResult = {
  ...
  questions:[{id:'q1',score:10},{id:'q2',score:6},{id:'q3',score:8}],
  findings:[
    {id:'graded-induction',questionId:'q2',category:'Circular reasoning',message:'The next case is assumed rather than derived.',pageIndex:1,x:.32,y:.48597,kind:'line',boxes:[{x:.11111,y:.47441,width:.2235,height:.02313}],deduction:4,applied:true},
    {id:'graded-domain',questionId:'q3',category:'Missing domain',message:'The condition k > 0 does not specify which values k can take.',pageIndex:2,x:.265,y:.36225,kind:'line',boxes:[{x:.11111,y:.35068,width:.16971,height:.02313}],deduction:2,applied:true},
  ],
};
