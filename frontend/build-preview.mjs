...
const modules = await Promise.all(['__debug__/api.mjs', '__debug__/sample.mjs', 'app.mjs'].map(read));
...
console.log('Created frontend/preview.html. Open directly in a browser; use Preview feedback for offline review.');
