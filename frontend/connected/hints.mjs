...
export function attachHintReview(root, ready, onApproved = async () => {}) {
  ...
  section.innerHTML = `<h2>Assignment hints</h2><p>Hints are prepared when you save assignment setup. Review them before finalizing the standard. Students receive these saved hints.</p><button type="button">Review / refresh hints</button><div role="status"></div><div class="hint-editor"></div>`;
  ...
  root.querySelector('.page-content')?.append(section);
}
